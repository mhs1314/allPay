...
public class Utils {
	...
	/** 时间转译 MM/dd HH:mm */
	public static SimpleDateFormat MMddkHHmm = new SimpleDateFormat("MM/dd HH:mm");
	/** 时间转译 MM月dd日  */
	public static SimpleDateFormat MMdd = new SimpleDateFormat("MM月dd日");
	/** 获得日期的中文月份 */
	public static SimpleDateFormat yuefen = new SimpleDateFormat("MMMM");
	/** 获得日期的中文星期 */
	public static SimpleDateFormat xingqi = new SimpleDateFormat("EEEE");
	 ...
	 * @return
	 */
	public static Double df2(Object obj) {
		BigDecimal bigLoanAmount = new BigDecimal(obj + ""); // 创建BigDecimal对象
		Double dou = Double.parseDouble(df2.format(bigLoanAmount));
		return dou;
	}
