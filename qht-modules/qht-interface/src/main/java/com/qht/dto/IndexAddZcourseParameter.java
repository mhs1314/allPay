...
public class IndexAddZcourseParameter implements Serializable{
	
	
	@Override
	public String toString() {
		return "IndexAddZcourseParameter [uid=" + uid + ", teacher_id=" + teacher_id + ", tenant_id=" + tenant_id
				+ ", course_type_id=" + course_type_id + ", pkg_subject_id=" + pkg_subject_id + ", pkg_edition_id="
				+ pkg_edition_id + ", pkg_grade_id=" + pkg_grade_id + ", pkg_level_id=" + pkg_level_id + ", pkg_name="
				+ pkg_name + ", play_type_id=" + play_type_id + ", min=" + min + ", max=" + max + ", content=" + content
				+ ", cover=" + cover + ", chapter_name=" + chapter_name + ", period_name=" + period_name + ", begin="
				+ begin + ", time_length=" + time_length + ", status=" + status + ", chapter_uid=" + chapter_uid
